 ...
 *
 * @author hyp
 * class name is StringUtil
 * Include in com.hyp.ol.utils
 * hyp create at 2018/9/16 13:43
 **/
...
public final class StringUtil {
     ...
     * @param arr                    待拼接的字符串数组
     * @param spliter                连接符
     * @param ignoreBlankStringInArr 是否忽略掉数组中的空字符串（即如果某个元素是个空字符串，则不把它拼接到结果字符串中。空字符串是指：null,"",
     *                               或者全部字符均为空白字符的字符串。）
     * @return
     */
